...
public class TimeAxis implements Component {
    ...
    public void draw(Graphics g) {
        if (enable) {
            ...
            tl = cur.get(curSet[selectedTime]).size();
            if (tl > 15)
                g.fillRect(this.x + 10 + this.width - 20, this.y + 50 + roller * (this.height - 50) / tl, 10, (this.height - 50) * 15 / tl);
        }
    }
    ...
    public void mouseDrag(int x, int y, int key) {
        if(RectangleOperation.pointInRectangle(x,y,
                this.width - 20,
                roller * (this.height - 50) / tl,
                ((this.height - 50) * 15 / tl)+this.width - 20,
        roller * (this.height - 50) / tl+(this.height - 50) * 15 / tl)){
            isDrag=true;
            if(LocationY-y>roller * (this.height - 50)*15){
                roller--;
            }
            if(y-LocationY>roller * (this.height - 50) *15){
                roller++;
            }
        }
        ...
        if(!RectangleOperation.pointInRectangle(x,y,
                ...
                ((this.height - 50) * 15 / tl)+this.width - 20,
                roller * (this.height - 50) / tl+(this.height - 50) * 15 / tl)){
            if(LocationY-y>roller * (this.height - 50) /50/tl){
                roller--;
                LocationY=y;
            }
            if(y-LocationY>roller * (this.height - 50) /50/tl){
                roller++;
                LocationY=y;
            }
        }
